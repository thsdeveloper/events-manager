...
export const AvailabilityStepForm = memo(function AvailabilityStepForm({
	form,
	quantitySold,
}: AvailabilityStepFormProps) {
			...
			<FormField
				...
				render={({ field }) => (
					<FormItem>
						...
						<FormDescription>Total de ingressos disponíveis para venda</FormDescription>
						{quantitySold > 0 && (
							<Alert variant="destructive" className="mt-2">
								<AlertDescription>
									Já foram vendidos {quantitySold} ingressos. A quantidade total deve ser maior ou igual a este valor.
								</AlertDescription>
							</Alert>
						)}
						<FormMessage />
			...
			<FormField
				...
				render={({ field }) => (
					<FormItem>
						...
						<FormDescription>Deixe em branco para sem limite mínimo</FormDescription>
						<FormMessage />
					</FormItem>
				)}
			/>
			...
			<FormField
				...
				render={({ field }) => (
					<FormItem>
						...
						<FormDescription>Deixe em branco para sem limite máximo</FormDescription>
						<FormMessage />
					</FormItem>
				)}
			/>
				...
				<Card>
					...
					<CardContent className="space-y-4">
						...
						<div className="space-y-2">
							...
							<div className="text-center text-sm text-muted-foreground">{soldPercentage.toFixed(0)}% vendidos</div>
						</div>
					</CardContent>
				</Card>
			)}
