...
const nextSteps = [
  ...
  { title: 'Configure seu perfil', description: 'Revise identidade e contato da organização.', href: '/admin/configuracoes', icon: Settings2 },
...
export function SuccessState({ organizerName = 'Organizador' }: { organizerName?: string; onGetStarted?: () => void }) {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <section className="relative overflow-hidden rounded-lg border border-emerald-200 bg-gradient-to-br from-emerald-50 via-white to-violet-50 p-8 shadow-sm sm:p-12">
        <div className="relative z-10 max-w-2xl">
          <div className="mb-5 flex size-14 items-center justify-center rounded-lg bg-emerald-600 text-white shadow-lg shadow-emerald-200"><CheckCircle2 className="size-7" /></div>
