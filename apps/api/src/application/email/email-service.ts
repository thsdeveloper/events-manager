...
export class EmailService {
  ...
  constructor(private readonly env: ApiEnv, private readonly clients: SupabaseClients) {
  ...
  async sendRegistrationConfirmation(registration: any, idempotencyKey: string) {
