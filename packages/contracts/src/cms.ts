...
export function normalizePermalink(value: string) {
...
export function isReservedPermalink(permalink: string) {
	return RESERVED_PERMALINK_PREFIXES.some(
		(prefix) => permalink === prefix || permalink.startsWith(`${prefix}/`),
	);
}
